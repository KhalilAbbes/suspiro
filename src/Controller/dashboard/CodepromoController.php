...
/**
 * @Route("/dashboard/codepromo")
 */
class CodepromoController extends AbstractController
{
    /**
     * @Route("/", name="codepromo_dashboard_index", methods={"GET"})
     */
    public function index(): Response
    {
        ...
        return $this->render('backend/indexCodepromo.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('codepromo_dashboard_index');
        }
